class DockerCompose133 < Formula
  desc "Development environments using Docker"
  ...
  depends_on "boot2docker162" => :recommended

  conflicts_with "docker-compose", :because => "Differing version of the same formula"
